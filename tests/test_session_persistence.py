...
class TestSessionSave:
    ...
    def test_session_save_creates_file(self):
        ...
        session = manager.create_session(working_directory="/home/user/project", model="gpt-4o")
...
class TestResumeRecentSession:
    ...
    def test_resume_without_session_id_returns_most_recent(self):
        ...
        session1 = manager.create_session(working_directory="/home/user/project1", model="gpt-4o")
        ...
        session2 = manager.create_session(working_directory="/home/user/project2", model="deepseek")
...
class TestSessionsList:
    ...
    def test_sessions_list_sorted_by_updated_at_desc(self):
        ...
        session3 = manager.create_session(working_directory="/home/user/project3", model="gpt-4o")
    ...
    def test_sessions_list_limit_20(self):
        ...
        for i in range(25):
            session = manager.create_session(
                working_directory=f"/home/user/project{i}", model="gpt-4o"
            )
...
class TestClearGeneratesNewSession:
    ...
    def test_clear_generates_new_session_id(self):
        ...
        session1 = manager.create_session(working_directory="/home/user/project", model="gpt-4o")
        session1.messages = [
            {"role": "system", "content": "You are MasterCoder"},
            {"role": "user", "content": "Hello"},
        ...
        session2 = manager.create_session(working_directory="/home/user/project", model="gpt-4o")
